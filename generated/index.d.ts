...
interface MLContext {
  ...
  readTensor(
    tensor: MLTensor,
    outputData: MLAllowSharedBufferSource,
  ): Promise<undefined>;
  writeTensor(
    tensor: MLTensor,
    inputData: MLAllowSharedBufferSource,
  ): undefined;
...
interface MLGraphBuilder {
  ...
  constant(
    ...
    buffer: MLAllowSharedBufferSource,
  ): MLOperand;
  ...
  pad(
    input: MLOperand,
    beginningPadding: Iterable<number>,
    endingPadding: Iterable<number>,
